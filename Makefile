...
all: cache_inquisitor.c cache_inquisitor1.c cache_inquisitor2.c cache_inquisitor3.c cache_inquisitor4.c
...
clean:
	rm cache_inquisitor 1_cache_inquisitor 2_cache_inquisitor 3_cache_inquisitor 4_cache_inquisitor
